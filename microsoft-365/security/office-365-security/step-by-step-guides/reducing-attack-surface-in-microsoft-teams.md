...
description: Configuration which can be used to reduce the attack surface in 
search.product: 
...
[Learn more](https://docs.microsoft.com/en-US/microsoftteams/manage-external-access) (detailed documentation)
...
Learn more about teams access policies: [Recommended Teams policies - Microsoft 365 for enterprise - Office 365 | Microsoft Docs](https://docs.microsoft.com/en-us/microsoft-365/security/office-365-security/teams-access-policies?view=o365-worldwide)

Security in Microsoft Teams:[Overview of security and compliance - Microsoft Teams | Microsoft Docs](https://docs.microsoft.com/en-us/microsoftteams/security-compliance-overview)
